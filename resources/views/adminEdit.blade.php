  ...
  <!-- nav bar start -->
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-5 text-black">Edit Account:</h2>
          </div>
          <div class="col-md-12">
          @if($errors->any())
            ...
            <input type="hidden" name="eid" value="{{$$adminInfo->id}}">
                ...
                <div class="form-group row">
                  ...
                  <label class="form-label" for="form3Example97">Phone</label>
                    <input type="number" name="phone" id="form3Example97" class="form-control form-control-lg" value="{{$adminInfo->phone}}"/>
                  </div>
                ...
                <label class="form-label" for="form3Example8">Address</label>
                  <input type="text" id="form3Example8" name="address" class="form-control form-control-lg" value="{{$adminInfo->address}}"/>
                ...
                <label class="form-label" for="form3Example90" >Pincode</label>
                  <input type="number" id="form3Example90" name="pincode" class="form-control form-control-lg" value="{{$adminInfo->pincode}}"/>
