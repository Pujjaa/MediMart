      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <strong class="text-black">Minerals</strong>
          </div>
        </div>
      </div>
    </div>
...
<div class="container-fluid pt-5">
  <div class="card-columns">
    @foreach($all->all() as $min)
  <div class="row row-cols-1 row-cols-md-3">
  <div class="col mb-4">
    <div class="card h-100">
      <img src="{{$min->image}}" class="card-img-top" alt="...">
      ...
      <div class="card-body text-dark">
        ...
        <p class="card-text">{{$min->description}}</p>
        <a href="{{url('/patMedSingle')}}{{$min->id}}" class="btn btn-md btn-outline-primary" style="color:green;">Add to cart</a>
        <a href="{{url('/patMedSingle')}}{{$min->id}}" class="btn btn-md btn-primary" style="color:white;">Buy Now</a>
      </div>
