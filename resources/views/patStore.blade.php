...
<div class="container-fluid pt-5">
  ...
  <div class="card">
    ...
    <div class="card-img-overlay">
      <a href="{{url('/patMedVit')}}" style="font-weight:bold;" class="btn btn-primary">Vitamins</a>
    </div>
  </div>
  <div class="card">
    <img src="images/minerals.jfif" class="card-img" alt="...">
    <div class="card-img-overlay">
      <a href="{{url('/patMedMin')}}" style="font-weight:bold;" class="btn btn-primary">Minerals</a>
    </div>
  </div>
  <div class="card">
    <img src="images/herbals.jfif" class="card-img" alt="...">
    <div class="card-img-overlay">
      <a href="{{url('/patMedHer')}}" style="font-weight:bold;" class="btn btn-primary">Herbals</a>
    </div>
  </div>
  <div class="card">
    <img src="images/proteins.jfif" class="card-img" alt="...">
    <div class="card-img-overlay">
      <a href="{{url('/patMedPro')}}" style="font-weight:bold;" class="btn btn-primary">Proteins and Fitness</a>
    </div>
  </div>
  <div class="card">
    <img src="images/probitics.jfif" class="card-img" alt="...">
    <div class="card-img-overlay">
      <a href="{{url('/patMedProbio')}}" style="font-weight:bold;" class="btn btn-primary">Probiotics and digestive</a>
    </div>
  </div>
  <div class="card">
    <img src="images/imune.jfif" class="card-img" alt="...">
    <div class="card-img-overlay">
      <a href="{{url('/patMedImu')}}" style="font-weight:bold;" class="btn btn-primary">Imune System</a>
    </div>
  </div>
