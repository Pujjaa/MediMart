...
<div class="container-fluid pt-5">
  <div class="card-columns">
    @foreach($allVit->all() as $vit)
  <div class="row row-cols-1 row-cols-md-3">
  <div class="col mb-4">
    <div class="card h-100">
      <img src="{{$vit->image}}" class="card-img-top" alt="...">
      <div class="d-flex align-items-center justify-content-center mb-1">
                            ...
                            <small>({{$vit->rate}})</small>
        </div>
      <div class="card-body text-dark">
        <h5 class="card-title">{{$vit->name}}</h5>
        <p class="card-text">₹{{$vit->price}}</p>
        <p class="card-text">{{$vit->description}}</p>
        <a href="{{url('/patMedSingle')}}{{$vit->id}}" class="btn btn-md btn-outline-primary" style="color:green;">Add to cart</a>
        <a href="{{url('/patMedSingle')}}{{$vit->id}}" class="btn btn-md btn-primary" style="color:white;">Buy Now</a>
      </div>
