      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <strong class="text-black">Herbals</strong>
          </div>
        </div>
      </div>
    </div>
...
<div class="container-fluid pt-5">
  <div class="card-columns">
    @foreach($all->all() as $her)
  <div class="row row-cols-1 row-cols-md-3">
  <div class="col mb-4">
    <div class="card h-100">
      <img src="{{$her->image}}" class="card-img-top" alt="...">
      <div class="d-flex align-items-center justify-content-center mb-1">
                            ...
                            <small>({{$her->rate}})</small>
        </div>
      <div class="card-body text-dark">
        <h5 class="card-title">{{$her->name}}</h5>
        <p class="card-text">₹{{$her->price}}</p>
        <p class="card-text">{{$her->description}}</p>
        <a href="{{url('/patMedSingle')}}{{$her->id}}" class="btn btn-md btn-outline-primary" style="color:green;">Add to cart</a>
        <a href="{{url('/patMedSingle')}}{{$her->id}}" class="btn btn-md btn-primary" style="color:white;">Buy Now</a>
      </div>
