...
<div class="container-fluid pt-3">
  <div class="card-columns">
    @foreach($all->all() as $allHer)
  <div class="row row-cols-1 row-cols-md-3">
  <div class="col mb-4">
    <div class="card h-100">
      <img src="{{$allHer->image}}" class="card-img-top" alt="...">
      <div class="d-flex align-items-center justify-content-center mb-1">
                            ...
                            <small>({{$allHer->rate}})</small>
        </div>
      <div class="card-body text-dark">
        <h5 class="card-title">{{$allHer->name}}</h5>
        <p class="card-text">₹{{$allHer->price}}</p>
        <p class="card-text">{{$allHer->description}}</p>
        <a href="{{url('/editProuct')}}{{$allHer->id}}{{$allHer->category}}" class="btn btn-sm btn-primary">Edit</a>
      <a href="{{url('/med_delete')}}{{$allHer->id}}{{$allHer->category}}" class="btn btn-sm btn-danger">Delete</a>
      </div>
