...
<div class="container-fluid pt-5">
  ...
  <div class="card">
    ...
    <div class="card-img-overlay">
      <a href="{{url('/adminSupVit')}}" style="font-weight:bold;" class="btn btn-primary">Vitamins</a>
    </div>
  </div>
  <div class="card">
    <img src="images/minerals.jfif" class="card-img" alt="...">
    <div class="card-img-overlay">
      <a href="{{url('/adminSupMin')}}" style="font-weight:bold;" class="btn btn-primary">Minerals</a>
    </div>
  </div>
  <div class="card">
