      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <strong class="text-black">Imune System</strong>
          </div>
        </div>
      </div>
    </div>
...
<div class="container-fluid pt-3">
  <div class="card-columns">
    @foreach($all->all() as $allImu)
  <div class="row row-cols-1 row-cols-md-3">
  <div class="col mb-4">
    <div class="card h-100">
      <img src="{{$allImu->image}}" class="card-img-top" alt="...">
      <div class="d-flex align-items-center justify-content-center mb-1">
                            ...
                            <small>({{$allImu->rate}})</small>
        </div>
      <div class="card-body text-dark">
        <h5 class="card-title">{{$allImu->name}}</h5>
        <p class="card-text">₹{{$allImu->price}}</p>
        <p class="card-text">{{$allImu->description}}</p>
        <a href="{{url('/editProuct')}}{{$allImu->id}}{{$allImu->category}}" class="btn btn-sm btn-primary">Edit</a>
      <a href="{{url('/med_delete')}}{{$allImu->id}}{{$allImu->category}}" class="btn btn-sm btn-danger">Delete</a>
      </div>
